...
def main():
    ...
    # SPX 125-day SMA (3 years of daily Stooq data)
    print("SPX 125d SMA (Stooq)...")
    try:
        ...
        r.raise_for_status()
        points = parse_stooq_csv(r.text)
        save("data/spx-sma.json", calculate_sma(points, 125))
    except Exception as e:
        print(f"    ERROR SPX SMA: {e}")
